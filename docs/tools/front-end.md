...
- [webpack](https://webpack.js.org/concepts/)
  - [postcss](https://postcss.org/) &nbsp;&nbsp;&nbsp;[lightningcss](https://lightningcss.dev/)
  - [babel](https://babeljs.io/docs/) &nbsp;&nbsp;&nbsp;[swc](https://swc.rs/)
- [gulp](https://gulpjs.com/) &nbsp;&nbsp;&nbsp;[gulp 中文](https://www.gulpjs.com.cn/)
- [grunt](https://gruntjs.com/) &nbsp;&nbsp;&nbsp;[grunt 中文](https://www.gruntjs.net/)
#### 代码管理
- [prettier](https://prettier.io/)
- [eslint](https://eslint.org/) &nbsp;[eslint中文](https://zh-hans.eslint.org/docs/latest/use/getting-started)
...
- [gitlab](https://docs.gitlab.com/) &nbsp;[gitlab 中文](https://gitlab.cn/)
...
- 请求库
  ...
  - [trpc](https://trpc.io/docs/quickstart) 配合 nextjs
- graphql
...
### 测试
#### 单元测试
- [jestjs](https://jestjs.io/docs/getting-started) &nbsp;&nbsp;&nbsp;[jestjs 中文](https://jestjs.io/zh-Hans/docs/getting-started)
