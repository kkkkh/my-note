...
- [vite](https://cn.vitejs.dev/guide/) 官网
  ...
  - [Rolldown](https://rolldown.rs/guide/) vite rust版本
  - [vite-plugin-inspect](https://github.com/antfu-collective/vite-plugin-inspect?tab=readme-ov-file)
- babel
  - babel
  - [swc](https://swc.rs/)
- rollup
  - [rollup](https://rollupjs.org/introduction/)
  - [rollup 中文](https://cn.rollupjs.org/introduction/)
...
- Axure
  - [Axure](https://axurehub.com/1475.html) 激活码1 [Axure](https://mybj123.com/4901.html) 激活码2
